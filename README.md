# ⚡ ESP32 Industrial 4-20mA Current Loop Transmitter & HART Modem
...
Precision analog current loop calibrator and process transmitter with digital HART Bell 202 FSK modulation/demodulation for smart industrial field instrumentation.
...
3. Pastikan dependensi pustaka terpasang via Library Manager:
   ...
   * `Wire` & `SPI`
   * `Preferences`
4. Buka berkas [`esp32-hart-4-20ma-current-loop.ino`](./esp32-hart-4-20ma-current-loop.ino).
